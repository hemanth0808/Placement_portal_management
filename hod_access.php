...
<a href="hod_reset_password.php" class="button"><img src="resetpassword.jpg" alt="resetpassword" width="20" height="20"></a>
	...
	<form method="POST" action="hodcompanylist.php">
        ...
        <tr><td align="right"><label>CGPA :</label></td>
		<td><input type="number" name="cgpa" step='0.01' min=4 max=10 placeholder="10.00" required><br></td></tr>
		...
		<tr><td><br></td></tr>
		<tr><td align="right"><input type="submit" id="submit" value="submit" name="submit" style="display:none;">
                <label for="submit"><img src="submit.jpg" alt="submit" width="80" height="30"></label></td>
		<td>
	...
	<form method="POST" action="#">
		...
		<tr><td align="right"><label for="regdno">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Regdno:</label></td>
			<td><input type="text" id="regdno" name="regdno" placeholder="19331a1208" required>
		</td></tr>
		<tr><td><br></td></tr>
		<tr><td align="right">
			<input type="submit" id="submit1" value="submit" name="submit" style="display:none;">
                <label for="submit1"><img src="submit.jpg" alt="submit" width="80" height="30"></label>
			</td>
		<td>
